...
def pi3x_match_asymmetric(
    ...
    # PI3X matching is generated by geometry reprojection, so the pose used here
    # directly controls correspondence validity. Tracker's init_relative_pose is
    # a stale optimization prior from the previous frame and is not reliable as
    # the reprojection basis for the current frame pair.
