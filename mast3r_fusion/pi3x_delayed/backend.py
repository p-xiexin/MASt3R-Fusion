...
from mast3r_fusion.pi3x_delayed.keyframes import update_t_wcs_global_checked
...
from mast3r_fusion.vio_utils import VisualIMUAlignment, keys2str, skew_sym
...
class Pi3XDelayedFactorGraph:
    ...
    def solve_imu_prior_window(self, window_end=None):
        ...
        update_t_wcs_global_checked(self.frames, T_WCs, opt_kf_idx)
        return True
    ...
    def solve_VI_init(self):
        ...
        if var_g < 0.0:
            ...
            update_t_wcs_global_checked(self.frames, T_WCs, unique_kf_idx[pin:])
